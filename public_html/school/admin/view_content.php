                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        for ($i = 0; $i < count($GetAllArticles); $i++) {
                            $getMenu = $objMenu->GetRowContent($GetAllArticles[$i]['menu_id']);
                            
                            ?>
                            <tr class="odd gradx">
                                 <td><?php echo $GetAllArticles[$i]['title'] ?></td>
                                <td class="center"><?php echo $getMenu['title'] ?></td>
                                <td class="center"><?php echo getSubString($GetAllArticles[$i]['editor'],0,50,NULL,NULL,NULL) ?></td>
                                <td class="center"><?php echo date_format_list($GetAllArticles[$i]['date_added']) ?></td>
                                                <td class="center">

                                                 <a  href="add_edit_content.php?id=<?php echo $GetAllArticles[$i]['id'] ?>"><i class="fa fa-edit"></i></a> 
