	...
	<div class="cart-page">
		<div class="product-inner">
			<div class="content">
				...
				<div class="list-title">My Cart</div>
						...
						<table class="table cart-box">
							<thead class="cart-titles">
								<tr>
									...
									<td class="cart-col">Remove</td>
									<td class="cart-col">Quantity</td>
									<td class="cart-col">Rate</td>
									<td class="cart-col">Total</td>
								</tr>
							</thead>

<?php
	if(empty($_SESSION['cart'])){$_SESSION['total']=0; $_SESSION['shipcost']=0;}
				...
				if($products != null){
					...
					$color[]=$products['color']; ?>
								<tr class="cart-details">
									...
									<td class="cart-col">
										<a href="action/cartaction.php?prid=<?php echo $products['prid'];?>" onclick="return confirm('Are you sure you want to remove this item?');">
...
?>
                        ...
                        <div class="cart-total">
                            <div class="ct-inner">
                                ...
                                <div class="ct-ship">Shipping Charge: <?php echo $_SESSION['shipcost'];?> AED </div>
                                <div class="ct-total">Total: <?php echo $_SESSION['total'];?> AED </div>
                            </div>
                        </div>

                        <div class="cart-bottom clearfix hh">
                            <div class="go-check col-xs-6 col-sm-push-6"><a href="javascript:void(0)"<?php if($_SESSION['dream']['user_id']!=""){ ?> onclick="checkout();" <?php }else{  ?> onclick="checklogin();" <?php } ?>>Proceed to Checkout</a></div>
                            <div class="cont-ship col-xs-6 col-sm-pull-6"><a href="list.php">Continue Shopping</a></div>
                        </div>
                    </form>
                </div>
            </div>
