								...
								<?php 
									if(isset($_SESSION['dream']))
									{
										if($_SESSION['dream']['type']=='school' || isset($_SESSION['dream']['code'])){
											echo '<li><a href="shop.php?mmid=7"><div class="schl-btn">SHOP LOCATION</div></a></li>
												<li><a href="size.php?mmid=8"><div class="schl-btn">UNAVILABLE SIZES</div></a></li>
												<li><a href="school.php?mmid=6"><div class="schl-btn">SCHOOL PROFILE</div></a></li>';
								...
								?>
									...
									<li>
										<div class="detail-cart"><a href="cart.php?mmid=9">
											...
											<div class="aed">My Bag (<?php echo count($_SESSION['cart']); ?>)</div></a>
										</div>
									</li>
								</ul>	
							</div>
