				...
				<table cellpadding="0" cellspacing="0" class="table table-bordered">
				     <form class="form-horizontal" role="form" action="action/edit-account.php" method="post" id="EditregisterForm">
						...
						<tr>
						    <td><b>Prénom:</b></td>
						    <td>
							<input type="text" class="form-control" id="first_name" name="first_name" value="<?php echo $getUser['first_name']; ?>" placeholder="Enter Prénom">
					    ...
					    <h3>Ordre Histroy</h3>
						    <div class="o-box">
	                            <div class="o-head">
	                                ...
	                                <div class="o-tran">numéro de commande</div>
