	...
	if($_REQUEST['response_message']=="Success" || $_GET['paylater'])
	{
		...
		if($numrow>0)
		{
			...
			if($GetOrderDet) {
				...
				<div style=' width: 200px;  text-align:left;  background: #eee;  padding: 2px 10px; font-weight: 600;'>Amount Due: <span style='float:right'>" . $gtot . " AED</span></div></td>
				</tr>
				</tbody>
				</table>
				</td>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">                
                <h4 class="modal-title">Thank you for placing order with Dream Uniforms LLC</h4>
            </div>
            <div class="modal-body mod-response">
                <p>Please check your email for delivery confirmation</p>
            </div>
