...
<div class="container">
	...
	<div class="product-inner">
	    <div class="content">
		<div class="list-title">MON SAC</div>
		...
		<!------------------------Shipping Charge Ends------------------->
			...
			<div class="go-check col-xs-6 col-sm-push-6">
			    <a href="javascript:void(0)"<?php if($_SESSION['dream']['user_id']!=""){ ?> onclick="checkout();" <?php }else{  ?> onclick="checklogin();" <?php } ?>>Passer a la caisse</a>
			</div>
