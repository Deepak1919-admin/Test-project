...
<body>
	...
	<div class="container">
		<div class="col-sm-5">
			<div class="logo"><img src="images/lfigp_new.jpg" height="120px" width="120px"></div>
		</div>
		<div class="col-sm-7">
			<div class="row">
				<div class="col-sm-6">
...
<div class="top-ban"><img src="images/t-ban.png">
	<div class="search-optn">
		<div><a href="#" data-toggle="modal" data-target="#schlogin-modal">Existing Customers - Login</a></div>
		<div><a href="#"  data-toggle="modal" data-target="#register-modal">New Customers - Sign Up</a></div>
  ...
  © Copyright 2016 Dream Uniforms LLC, Dubai.
</div>
</div>
<!--------------------Login modal------------------------------->
				...
				<?php }else{?>
					<form class="form-horizontal" action="" role="form" name="schoo-login" method="post" id="schoo-login">
						...
						<div class="form-group">
							<label class="control-label col-sm-4" for="username">School Code:</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" id="code" name="code" value="LFIGP"  placeholder="School Code" readonly="true">
							</div>
						</div>
						<div class="form-group">
...
<a href="" data-toggle="modal" data-target="#help" id="forgotPasswords" style="float:right"><font color="black" > <b>Do you need help? click here</b></font></a>
						</div>
					</form>
				<?php }?>
				</div>
