						...
						<div class="row">
							...
							<div class="col-sm-8">
								<div class="login-detail">
									<ul>
										<li><a href="javascript:void(0);">Wel come <?php echo $_SESSION['dream']['name']; ?> |</a></li>
			...
			<div class="sec-detail">
				<div class="container">
					...
					<div class="col-sm-8">
						...
						<?php 
							if(isset($_SESSION['dream'])){
								if($_SESSION['dream']['type']=='school' || isset($_SESSION['dream']['code'])){
									echo '<div class="col-sm-2"><div class="schl-btn"><a href="shop.php?mmid=7">SHOP LOCATION</a></div></div>
										<div class="col-sm-2"><div class="schl-btn"><a href="size.php?mmid=8">UNAVILABLE SIZES</a></div></div>
										<div class="col-sm-2"><div class="schl-btn"><a href="school.php?mmid=6">ABOUT US</a></div></div>';
						...
						?>
							<div class="col-sm-2"><div class="direct-btn"><a href="list.php?mmid=5">DIRECT PURCHASE</a></div></div>
