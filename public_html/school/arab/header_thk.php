						...
						<?php 
							if(isset($_SESSION['dream'])){
								if($_SESSION['dream']['type']=='school' || isset($_SESSION['dream']['code'])){
									echo '<div class="col-sm-2"><div class="schl-btn"><a href="shop.php?mmid=7">متجر الموقع</a></div></div>
										<div class="col-sm-2"><div class="schl-btn"><a href="size.php?mmid=8">الأحجام المتوفرة</a></div></div>
										<div class="col-sm-2"><div class="schl-btn"><a href="school.php?mmid=6">معلومات عنا</a></div></div>';
								}else if($_SESSION['dream']['type']=='corporate'){
									echo '<div class="col-sm-2"><div class="schl-btn"><a href="corporate.php">لمحة عن الشركة</a></div></div>';
								}
							}
						?>
							<div class="col-sm-2"><div class="direct-btn"><a href="list.php?mmid=5">الشراء المباشر</a></div></div>
