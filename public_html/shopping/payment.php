...
{
 $six_digitId  = mt_rand(100000, 999999);
$result = mysql_query("SELECT * FROM tblorder where order_id=".$six_digitId);
...
if(isset($_REQUEST['paynow'])) {
    ...
    if (strlen($b) <= 2) {
        $_SESSION['msg'] = '<span style="color:red">Please Enter Valid Address </span>';
