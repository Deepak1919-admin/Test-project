...
$res = $objUser->ForgotPassword($_POST['email']);
if($res['password'] != ''){
	$content='<table width="650" height="132"  border="0" cellpadding="0" cellspacing="0" style="border:1px solid #e1c055">
				...
				<tr>
					<td height="40" align="center" valign="middle" bgcolor="#EEAF3B"><strong>Copyright info@flukegate.com. All Rights Reserved </strong></td>
				</tr>
			</table>';
			
$to = $_POST['email'];
$subject = "Forgot Password";
$by="flukegate Properties";
$from='info@flukegate.com';
$headers  = 'MIME-Version: 1.0' . "\r\n";
$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
$headers .= 'Bcc: schoollog@dullc.ae' . "\r\n";
