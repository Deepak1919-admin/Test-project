					...
					<div class="col-sm-5 inner-right">
						<div class="detail-block match-col">
							...
							<div class="shoe-size">
								...
								: <select class="s-select size-select" name="size_id" id="size_id" onchange="select_siz(this.value,'<?php echo $pid;?>')">
							...
							<div class="shoe-qty clearfix">
								...
								: <label class="pricy-tag" id="price_val" >AED <?php echo $product_dt['price']; ?></label>
