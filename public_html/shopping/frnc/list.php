...
include("banner.php");
?>
<div class="pro-head">COMMANDER EN LIGNE</div>
	<div class="container">
		<div class="list-con">
			<div class="col-sm-3">
				<div class="list-sec">
					<form name="sort_pro" id="sort_pro" method="GET">
						...
						<div class="listing-sec">
							<div class="listing-title">Garçon/Fille</div>
						...
						<div class="list-sec-bt"><input type="submit" name="submit" value="ENVOYER"></div>
					</form>
				</div>
			</div>
			<div class="col-sm-9">
							...
							<div class="col-lg-3 col-md-4 col-xs-6 ls-item">
								<div class="list-sub-in">
									...
									<div class="inlist-sec">
										...
										<div><!--AED <?php echo $product[$i]['price']; ?> |--> <a href="detail.php?pid=<?php echo $product[$i]['id']; ?>&mmid=5"><font color="#B4DB15">BUY NOW</font></a></div>
									</div>
								</div>
							</div>
				<?php 	}
