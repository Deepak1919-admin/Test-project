...
if (isset($_POST['submit'])) {
    if (isset($_POST['id']) && $_POST['id']) {
        ...
        $objService->setArrData($_POST);
        $res = $objService->update($_POST['id']);
...
if (isset($getId)) {
    $row = $objService->GetRowContent($getId);
}
?>
            ...
            <div class="col-lg-12">
                <div class="page-title">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"> <a href="<?php echo currenturl() ?>"><?php echo ucfirst($action) ?> Service</a></li>
                    </ol>
                </div>
            </div>
            <!-- /.col-lg-12 -->
                ...
                <div class="portlet portlet-default">
                    <div class="portlet-heading">
                        <div class="portlet-title">
                            <h4><?php echo ucfirst($action) ?> Service</a></h4>
                        </div>
                        ...
                        <div class="portlet-body">
                         ...
                         <?php	if (!empty($row['image'])){ ?>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div style="width: 150px;margin-left:175px;right: 70px; top: 190px;"><img style="width: 100px" src="<?php echo "../multimedia/banner/" . $row['image'] ?>"></div>
                                        </div>
                                    </div>
						<?php	}?>
                                <div class="form-group ">
