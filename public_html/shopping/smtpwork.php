 ...
 */
	...
	$from="website@dreamuniforms.ae";                           /* Change this to your address like "me@mydomain.com"; */ 
	...
	$smtp->host_name="www.dreamuniforms.ae"; //IP address       /* Change this variable to the address of the SMTP server to relay, like "smtp.myisp.com" */
	...
	$smtp->user="website@dreamuniforms.ae";                     /* Set to the user name if the server requires authetication */
	$smtp->realm="";                    /* Set to the authetication realm, usually the authentication user e-mail domain */
	$smtp->password="Hello@1985";                 /* Set to the authetication password */
