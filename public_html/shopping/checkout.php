    ...
    <div>
        <div class="product-inner">
            <div class="content">
                ...
                <div class="list-title"><font size="5px">SHIPPING ADDRESS</font></div>
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                      <b>All fields marked with an asterisk (*) are required.  </b>
					<form name="userform" method="post" action="payment.php" id="checkout">
                        <div class="checkout-form row">
                            ...
                            <div class="check-ip col-xs-6">
                                ...
                                <input type="text" name="phone" class="form-control" required="" value="<?php echo $phone;?>" placeholder="Contact Number">
                            </div>
                            <div class="check-ip col-xs-6">
